...
**🎉 NEW: Carousel Mode with Responsive Settings!** Display multiple slides at once with customizable responsive breakpoints for desktop, tablet, and mobile devices.
...
Sliderberg stands out as the ultimate Slider Block plugin for WordPress Gutenberg Editor, crafted for performance, simplicity, and versatility. Here’s why it’s the perfect choice for your website:
...
* **Slide Anything You Can Imagine:** Go beyond just images! With Sliderberg, you can add any Gutenberg block inside your slides. This means you can create sliders featuring text, buttons, videos, testimonials, products, and more – the possibilities are endless!
...
You can explore all the live demos on our [Sliderberg Demos Page](http://sliderberg.com/demos/). From hero sliders to testimonial carousels - see what’s possible!
...
Yes! That’s the power of Sliderberg — you can slide anything. Add images, text, buttons, groups, or any native block to each slide.
...
Yes! Carousel mode includes responsive settings with separate configurations for desktop (≥1024px), tablet (768-1023px), and mobile (<768px) devices.
...
* NEW: Global height control for all slides in slider block for consistent sizing
* IMPROVED: Slide positioning constraints to prevent slides from moving outside the slider container
* IMPROVED: Placeholder design updated to match WordPress cover block style for better consistency
* IMPROVED: Removed the type selector in starting to simplify the initial setup process

= 1.0.7 =

* NEW: Add, duplicate, and delete buttons are now on the block toolbar for both the slider and each slide manage slides faster.
* IMPROVED: Editor updated to use the latest Gutenberg components for a cleaner and more consistent editing experience.
* IMPROVED: Replaced deprecated components to reduce bugs and avoid unexpected behavior.

= 1.0.6 =

* FIX: Asset registration order - CSS and JS now properly load in editor and frontend
* FIX: Carousel mode displaying incorrect number of slides in editor
* FIX: Navigation arrow positioning and hover jump issues in editor
* FIX: Missing block.json file in plugin zip distribution
* IMPROVED: Editor script dependencies now loaded from generated asset file
