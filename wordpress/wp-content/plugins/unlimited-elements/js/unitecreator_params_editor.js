...
function UELM_UniteCreatorParamsEditor(){

	var t = this;
	var g_objWrapper, g_objTableBody, g_objEmptyParams, g_type;
	var g_objDialog = new UELM_UniteCreatorParamsDialog(), g_buttonAddParam;
	...
	function initCatsEvents(){
		...
		g_objParamsDialogSpecial = new UELM_UniteCreatorParamsDialog();
