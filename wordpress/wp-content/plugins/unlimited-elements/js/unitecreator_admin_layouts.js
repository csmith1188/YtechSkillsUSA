...
function UELM_UniteCreatorAdmin_LayoutsList(){
	
	var t = this;
	var g_providerAdmin = new UELM_UniteProviderAdminUC();
	var g_settingsGlobal, g_tableLayouts;
	var g_objBrowser = new UELM_UniteCreatorBrowser(),g_objButtonCatalogImport;
	...
	function initGlobalSettingsDialog(){
		...
		g_settingsGlobal = new UELM_UniteSettingsUC();
