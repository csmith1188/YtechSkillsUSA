...
function UELM_UniteCreatorAdmin(){

	var t = this, g_objWrapper;
	var g_providerAdmin = new UELM_UniteProviderAdminUC();
	var g_objIncludes = new UELM_UniteCreatorIncludes();

	var g_generalSettings = new UELM_UniteSettingsUC();

	var g_paramsEditorMain = new UELM_UniteCreatorParamsEditor();
	var g_paramsEditorItems = new UELM_UniteCreatorParamsEditor();

	var g_objDialogParam = new UELM_UniteCreatorParamsDialog();
	var g_objDialogItemVariable = new UELM_UniteCreatorParamsDialog();
	var g_objDialogMainVariable	= new UELM_UniteCreatorParamsDialog();
	...
	var g_settingsItem = new UELM_UniteSettingsUC();
	var g_settingsJS = new UELM_UniteSettingsUC();

	var g_addonID = null, g_objItemSettingsWrapper, g_objWrapperItems;

	//param panels
	var g_paramsPanelMain = new UELM_UniteCreatorParamsPanel();

	var g_paramsPanelItem = new UELM_UniteCreatorParamsPanel();
	var g_paramsPanelItem2 = new UELM_UniteCreatorParamsPanel();

	var g_paramsPanelJs = new UELM_UniteCreatorParamsPanel();
	var g_paramsPanelCss = new UELM_UniteCreatorParamsPanel();
	var g_paramsPanelCssItem = new UELM_UniteCreatorParamsPanel();

	var g_objVariables = new UELM_UniteCreatorVariables();
	...
	function initParamPanelGlobals(arrChildKeys, initParamPanelGlobals, arrAddKeys, arrSkipParams){
		...
		var objParamPanel = new UELM_UniteCreatorParamsPanel();
  ...
  function getRevisionId(element) {
	...
	function updateDynamicPostKeys(arrPostChildKeys, key){
		...
		var objPanel = new UELM_UniteCreatorParamsPanel();
