...
function UELM_UniteCreatorPageBuilder(){
	
	var t = this;
	var g_objIframe, g_objWrapper, g_panel, g_layoutID, g_layoutType = null;
	var g_panelActions = new UELM_UniteCreatorGridActionsPanel();
	var g_gridBuilder, g_objPanelWrapper;
	var g_objSettings = new UELM_UniteSettingsUC();
	var g_objBuffer = new UELM_UniteCreatorBuffer();
	var g_panel = new UELM_UniteCreatorGridPanel();
	var g_objBrowser = new UELM_UniteCreatorBrowser();
	var g_objBrowserSections = new UELM_UniteCreatorBrowser();
