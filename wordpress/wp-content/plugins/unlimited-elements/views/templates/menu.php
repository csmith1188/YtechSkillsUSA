<div class="ue-root ue-menu">
	<?php if(UELM_GlobalsUnlimitedElements::$enableDashboard === true): ?>
		<a
			class="ue-menu-item <?php echo ($view === UELM_GlobalsUnlimitedElements::VIEW_DASHBOARD ? "ue-active" : ""); ?>"
			href="<?php echo esc_url(UELM_HelperUC::getViewUrl(UELM_GlobalsUnlimitedElements::VIEW_DASHBOARD)); ?>"
		>
			<?php echo esc_html__("Home", "unlimited-elements"); ?>
	...
	<?php endif ?>
	<a
		class="ue-menu-item <?php echo ($view === UELM_GlobalsUnlimitedElements::VIEW_ADDONS_ELEMENTOR ? "ue-active" : ""); ?>"
		href="<?php echo esc_url(UELM_HelperUC::getViewUrl(UELM_GlobalsUnlimitedElements::VIEW_ADDONS_ELEMENTOR)); ?>"
	>
		<?php if(UELM_GlobalsUnlimitedElements::$isGutenbergOnly):?>
			<?php echo esc_html__("Blocks", "unlimited-elements"); ?>
		<?php else:?>
			<?php echo esc_html__("Widgets", "unlimited-elements"); ?>
		<?php endif?>
	...
	<?php if(UELM_HelperProviderUC::isBackgroundsEnabled() === true): ?>
		<a
			class="ue-menu-item <?php echo ($view === UELM_GlobalsUnlimitedElements::VIEW_BACKGROUNDS ? "ue-active" : ""); ?>"
			href="<?php echo esc_url(UELM_HelperUC::getViewUrl(UELM_GlobalsUnlimitedElements::VIEW_BACKGROUNDS)); ?>"
		>
			<?php echo esc_html__("Backgrounds", "unlimited-elements"); ?>
			<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
	...
	<?php if(UELM_GlobalsUnlimitedElements::$enableElementorSupport == true):?>
	<a
		class="ue-menu-item <?php echo ($view === UELM_GlobalsUnlimitedElements::VIEW_TEMPLATES_ELEMENTOR ? "ue-active" : ""); ?>"
		href="<?php echo esc_url(UELM_HelperUC::getViewUrl(UELM_GlobalsUnlimitedElements::VIEW_TEMPLATES_ELEMENTOR)); ?>"
	>
	
		<?php echo esc_html__("Templates", "unlimited-elements"); ?>
		<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
	...
	<?php if(UELM_HelperProviderUC::isFormEntriesEnabled() === true): ?>
		<a
			class="ue-menu-item <?php echo ($view === UELM_GlobalsUnlimitedElements::VIEW_FORM_ENTRIES ? "ue-active" : ""); ?>"
			href="<?php echo esc_url(UELM_HelperUC::getViewUrl(UELM_GlobalsUnlimitedElements::VIEW_FORM_ENTRIES)); ?>"
		>
			<?php echo esc_html__("Form Entries", "unlimited-elements"); ?>
			<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
	...
	<?php endif; ?>
	<a
		class="ue-menu-item <?php echo ($view === UELM_GlobalsUnlimitedElements::VIEW_SETTINGS_ELEMENTOR ? "ue-active" : ""); ?>"
		href="<?php echo esc_url(UELM_HelperUC::getViewUrl(UELM_GlobalsUnlimitedElements::VIEW_SETTINGS_ELEMENTOR)); ?>"
	>
		<?php echo esc_html__("Settings", "unlimited-elements"); ?>
		<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
	...
	<a
		class="ue-menu-item"
		href="<?php echo esc_url(UELM_GlobalsUnlimitedElements::$urlAccount); ?>"
	>
		<?php echo esc_html__("Account", "unlimited-elements"); ?>
		<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
	...
	<a
		class="ue-menu-item"
		href="<?php echo esc_url(UELM_GlobalsUC::URL_SUPPORT); ?>"
		target="_blank"
	>
		<?php echo esc_html__("Support", "unlimited-elements"); ?>
		<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
