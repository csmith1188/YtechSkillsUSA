...
UELM_HelperUC::addStyle("jquery.fancybox", "fancybox", "assets_libraries/fancybox3");
UELM_HelperUC::addScript("jquery.fancybox", "fancybox", "assets_libraries/fancybox3");
UELM_HelperUC::addStyle("unitecreator_dashboard", "unitecreator_dashboard");

$isProVersion = UELM_GlobalsUC::$isProVersion;


$showFreeVersion = UELM_UniteFunctionsUC::getGetVar("showfreeversion", "", UELM_UniteFunctionsUC::SANITIZE_TEXT_FIELD);
$showFreeVersion = UELM_UniteFunctionsUC::strToBool($showFreeVersion);

if($showFreeVersion === true)
	$isProVersion = false;

$api = new UELM_UniteCreatorWebAPI();

$blogItems = $api->getCatalog_blog();


$imagesUrl = UELM_GlobalsUC::$urlPluginImages . "dashboard/";

$videoItems = array(
	array(
		"url" => "https://youtu.be/SnNI9_KXY9Y?si=xz3to9IYlYeBJ8qd",
		"title" => __("Give Your Elementor Website Superpowers with Unlimited Elements", "unlimited-elements"),
		"image" => $imagesUrl . "tutorials/video-1.jpg",
	),
	array(
		"url" => "https://youtu.be/pvZ5Lvom470?si=cX2vhhgfzsjnBJd1",
		"title" => __("Unlimited Elements Widget Creator for Elementor Page Builder", "unlimited-elements"),
		"image" => $imagesUrl . "tutorials/video-2.jpg",
	),
	array(
		"url" => "https://youtu.be/ZdYCoD8_qxo?si=UalRKpw6udz9K3W0",
		"title" => __("Remote Control Widgets to Create Advanced Interactive Layouts", "unlimited-elements"),
...
UELM_HelperHtmlUC::putHtmlAdminNotices();

$isBFMode = UELM_GlobalsUnlimitedElements::$blackFridayMode && $isProVersion == false;

$showBFBanner = (UELM_GlobalsUnlimitedElements::$blackFridayMode == true);

if($showBFBanner == true){
	$urlBannerImage = UELM_GlobalsUC::$urlPluginImages."banners/ue-dashboard-bf-banner.png";	
}
	...
	<div class="ue-content-main ue-left">
		...
		<div class="ue-social-content-wrapper">
			...
			<div class="ue-content-card ue-yt">
				...
				<div class="ue-content-title">
					<?php echo esc_html__("Subscribe to", "unlimited-elements"); ?>
					<?php echo esc_html__("Our YouTube Channel", "unlimited-elements"); ?>
				</div>
				<div class="ue-content-desc">
					<?php echo esc_html__("Subscribe to our YouTube channel and never miss out on exciting content, useful tutorials, and important updates! Hit the \"Subscribe\" button now to join our growing community of viewers.", "unlimited-elements"); ?>
				</div>
				<a class="ue-content-btn ue-flex-center" href="<?php echo esc_url(UELM_GlobalsUC::URL_YOUTUBE); ?>" target="_blank">
					<?php echo esc_html__("Subscribe", "unlimited-elements"); ?>
				</a>
			</div>
			<!-- Facebook -->
			<div class="ue-content-card ue-fb">
				...
				<div class="ue-content-title">
					<?php echo esc_html__("Join", "unlimited-elements"); ?>
					<?php echo esc_html__("Our Facebook Group", "unlimited-elements"); ?>
				</div>
				<div class="ue-content-desc">
					<?php echo esc_html__("Stay updated on the latest news, connect with like-minded individuals, and access exclusive content! Click the \"Join Group\" button below and be a part of our supportive community.", "unlimited-elements"); ?>
				</div>
				<a class="ue-content-btn ue-flex-center" href="<?php echo esc_url(UELM_GlobalsUC::URL_FACEBOOK); ?>" target="_blank">
					<?php echo esc_html__("Join Group", "unlimited-elements"); ?>
				</a>
			</div>
		</div>
		...
		<div class="ue-content-card ue-tutorials">
			<div class="ue-tutorials-header">
				...
				<div class="ue-inner-content-wrapper-h">
					<div class="ue-content-title">
						<?php echo esc_html__("Video Tutorials", "unlimited-elements"); ?>
					</div>
					<div class="ue-content-desc">
						<?php echo esc_html__("3 important videos to get you started with Unlimited Elements.", "unlimited-elements"); ?>
					</div>
				</div>
				<a class="ue-content-btn ue-flex-center ue-tmore-btn-1" target="_blank" href="<?php echo esc_url($urlVideoTutorials); ?>">
					<?php echo esc_html__("View More", "unlimited-elements"); ?>
				</a>
			</div>
		...
		<div class="ue-content-card ue-full-card ue-flex-center">
			<div class="ue-inner-section-left">
				...
				<div class="ue-content-title">
					<?php echo esc_html__("Do You Love Unlimited Elements?", "unlimited-elements"); ?>
				</div>
				<div class="ue-content-desc">
					<?php echo esc_html__("Let us know. Your ratings and reviews contribute to making our WordPress plugin even better. Help us out with a 5 star review on the WP plugin repository.", "unlimited-elements"); ?>
				</div>
				<a class="ue-content-btn ue-flex-center" href="<?php echo esc_url(UELM_GlobalsUC::URL_RATE); ?>" target="_blank">
					<?php echo esc_html__("Rate Us", "unlimited-elements"); ?>
				</a>
			</div>
		...
		<div class="ue-content-card ue-full-card ue-flex-center">
			<div class="ue-inner-section-left">
				...
				<div class="ue-content-title">
					<?php echo esc_html__("Knowledge Base", "unlimited-elements"); ?>
				</div>
				<div class="ue-content-desc">
					<?php echo esc_html__("Looking for answers or helpful resources about our WordPress plugin? Check out our comprehensive Knowledge Base, where you'll find step-by-step guides, troubleshooting tips, and useful information to make the most of our plugin's features.", "unlimited-elements"); ?>
				</div>
				<a class="ue-content-btn ue-flex-center" href="<?php echo esc_url(UELM_GlobalsUC::URL_DOCS); ?>" target="_blank">
					<?php echo esc_html__("Documentation", "unlimited-elements"); ?>
				</a>
			</div>
			<div class="ue-inner-section-right ue-flex-center">
		...
		<?php if($isProVersion === false): ?>
			<div class="ue-content-card ue-full-card ue-flex-center">
				<div class="ue-inner-section-left">
					...
					<div class="ue-content-title">
						<?php echo esc_html__("Upgrade to Unlimited Elements Premium", "unlimited-elements"); ?>
					</div>
					<ul class="ue-features-list">
						<li class="ue-feature"><?php echo esc_html__("24/7 Premium Support", "unlimited-elements"); ?></li>
						<li class="ue-feature"><?php echo esc_html__("Copy & Paste Fully Designed Sections", "unlimited-elements"); ?></li>
						<li class="ue-feature"><?php echo esc_html__("30 Day Money Back Guarantee", "unlimited-elements"); ?></li>
						<li class="ue-feature"><?php echo esc_html__("Unique Widget Creator for Your Customer Requests", "unlimited-elements"); ?></li>
						<li class="ue-feature"><?php echo esc_html__("Easy Chat for Any Question", "unlimited-elements"); ?></li>
						<li class="ue-feature"><?php echo esc_html__("Animated Backgrounds & Premium Templates", "unlimited-elements"); ?></li>
					</ul>
					<a class="ue-content-btn ue-flex-center ue-pro-cta-btn" href="<?php echo esc_url(UELM_GlobalsUC::$url_buy_platform); ?>" target="_blank">
						<?php echo esc_html__("Get Unlimited Elements Premium", "unlimited-elements"); ?>
					</a>
				</div>
				<div class="ue-inner-section-right ue-flex-center">
	...
	<div class="ue-sidebar">
		<div class="ue-cta-post-wrapper">
			...
			<div class="ue-content-card ue-dashboard-banner">
				<a class="ue-dashboard-banner__link" href="<?php echo esc_url(UELM_GlobalsUC::$url_buy_platform)?>">
			...
			<?php if($isProVersion === false): ?>
				...
				<div class="ue-content-card ue-get-pro-cta">
					...
					<a href="<?php echo esc_url(UELM_GlobalsUC::$url_buy_platform)?>"
						target="_blank"
						class="ue-content-btn ue-flex-center ue-pro-cta-btn">Get Unlimited Elements Pro</a>
					<ul class="ue-cta-features-list">
						<li class="ue-cta-feature"><?php echo esc_html__("300+ Premium Widgets", "unlimited-elements"); ?></li>
						<li class="ue-cta-feature"><?php echo esc_html__("25+ Backgrounds", "unlimited-elements"); ?></li>
						<li class="ue-cta-feature"><?php echo esc_html__("Live Copy Paste", "unlimited-elements"); ?></li>
						<li class="ue-cta-feature"><?php echo esc_html__("Mega Menu", "unlimited-elements"); ?></li>
						<li class="ue-cta-feature"><?php echo esc_html__("Mega Slider", "unlimited-elements"); ?></li>
						<li class="ue-cta-feature"><?php echo esc_html__("Dynamic Loop Builder", "unlimited-elements"); ?></li>
						<li class="ue-cta-feature"><?php echo esc_html__("Multi-Source Widgets", "unlimited-elements"); ?></li>
						<li class="ue-cta-feature"><?php echo esc_html__("Calculators", "unlimited-elements"); ?></li>
					</ul>
					<a class="ue-cta-link" href="<?php echo esc_url(UELM_GlobalsUC::URL_FEATURES); ?>" target="_blank">
						<?php echo esc_html__("View All", "unlimited-elements"); ?>
			...
			<div class="ue-content-card ue-blog-section">
				...
				<div class="ue-content-title">
					<?php echo esc_html__("Our Blog", "unlimited-elements"); ?>
				</div>
				...
				<a class="ue-post-view-more ue-content-btn ue-flex-center" href="<?php echo esc_url(UELM_GlobalsUC::URL_BLOG); ?>" target="_blank">
					<?php echo esc_html__("View More", "unlimited-elements"); ?>
				</a>
			</div>
			<?php endif?>
			...
			<div class="ue-content-card ue-doubly-section">
				...
				<div class="ue-content-title">
					<?php echo esc_html__("Live Copy Paste", "unlimited-elements"); ?>
				</div>
				<div class="ue-content-desc">
					<?php echo esc_html__("Copy and paste fully designed sections from the Unlimited Elements website directly to your website.", "unlimited-elements"); ?>
				</div>
				<a class="ue-content-btn ue-flex-center" href="<?php echo esc_url(UELM_GlobalsUC::URL_DOUBLY); ?>" target="_blank">
					<?php echo esc_html__("See How it Works", "unlimited-elements"); ?>
				</a>
			</div>
