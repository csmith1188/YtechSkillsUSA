...
class UELM_UniteHelperBaseUC extends UELM_HtmlOutputBaseUC{
	...
	public static function ajaxResponse($success,$message,$arrData = null){
		...
		$isJsonOutput = UELM_UniteFunctionsUC::getGetVar("json","",UELM_UniteFunctionsUC::SANITIZE_KEY);
		$isJsonOutput = UELM_UniteFunctionsUC::strToBool($isJsonOutput);
