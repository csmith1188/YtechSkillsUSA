...
abstract class UELM_GoogleAPIClient{
	...
	protected function get($endpoint, $params = array()){
		...
		return $this->request(UELM_HttpRequest::METHOD_GET, $endpoint, $params);
	}
	...
	protected function put($endpoint, $params = array()){
		...
		return $this->request(UELM_HttpRequest::METHOD_PUT, $endpoint, $params);
	}
	...
	protected function post($endpoint, $params = array()){
		...
		return $this->request(UELM_HttpRequest::METHOD_POST, $endpoint, $params);
	}
	...
	private function throwError($message){
		...
		UELM_UniteFunctionsUC::throwError("Google API Error: $message");
	}
