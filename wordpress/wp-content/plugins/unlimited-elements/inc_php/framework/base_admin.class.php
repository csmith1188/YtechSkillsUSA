...
if ( ! defined( 'ABSPATH' ) ) exit;
 ...
 class UELM_UniteBaseAdminClassUC{
		...
		private function initView(){
			...
			$defaultView = UELM_GlobalsUC::$view_default;
			
			//set view
			$viewInput = UELM_UniteFunctionsUC::getGetVar("view","",UELM_UniteFunctionsUC::SANITIZE_KEY);
		...
		private static function getPluginViewFilePath($viewFilepath, $view){
			...
			$arrViewPaths = UELM_GlobalsUC::$arrAdminViewPaths;
		...
		protected static function requireView($view){
			...
			try{
				...
				if(!empty(self::$master_view) && !isset(self::$tempVars["is_masterView"]) ){
					$masterViewFilepath = UELM_GlobalsUC::$pathViews.self::$master_view.".php";
					
					UELM_UniteFunctionsUC::validateFilepath($masterViewFilepath,"Master View");
					...
					$viewFilepath = UELM_GlobalsUC::$pathViews.$view.".php";
					$pathViewProvider = UELM_GlobalsUC::$pathProviderViews.$view.".php";
					...
					$viewFilepath = UELM_UniteProviderFunctionsUC::applyFilters(UELM_UniteCreatorFilters::FILTER_ADMIN_VIEW_FILEPATH, $viewFilepath, $view);
					
					UELM_UniteFunctionsUC::validateFilepath($viewFilepath,"View");
