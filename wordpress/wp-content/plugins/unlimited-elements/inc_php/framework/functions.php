...
//---------------------------------------------------------------------------------------------------------------------	
	...
	if(!function_exists("uelm_dmp")){
		function uelm_dmp($str){ 
	...
	if(!function_exists("uelm_dmpHtml")){
		function uelm_dmpHtml($str){
			uelm_dmp(htmlspecialchars($str));
		}
	}
	 
	if(!function_exists("uelm_dmpGet")){
		
		function uelm_dmpGet($str){
