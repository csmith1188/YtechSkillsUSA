...
class UELM_UniteCreatorPlugins extends UELM_UniteCreatorFilters{
	...
	public function initPlugins(){
		...
		if(self::$isInited == true)
			UELM_UniteFunctionsUC::throwError("The plugins are already inited");
		
		$arrPaths = UELM_UniteProviderFunctionsUC::getArrPluginsPaths();
