...
if(!defined("UELM_UNLIMITED_ELEMENTS_VERSION"))
	define("UELM_UNLIMITED_ELEMENTS_VERSION", "2.0.5");

//disable elementor support for debugging purposes. keep it commented
//define("UELM_DISABLE_ELEMENTOR_SUPPORT", true);
...
require_once UELM_GlobalsUC::$pathProvider . 'provider_operations.class.php';
...
require_once UELM_GlobalsUC::$pathProvider . 'provider_categories.class.php';
...
require_once UELM_GlobalsUC::$pathProvider . 'provider_addon.class.php';
require_once $folderIncludesMain . 'unitecreator_params_processor.class.php';
require_once UELM_GlobalsUC::$pathProvider . 'provider_params_processor.class.php';
require_once UELM_GlobalsUC::$pathProvider . 'provider_params_processor_multisource.class.php';
...
require_once UELM_GlobalsUC::$pathProvider . 'provider_output.class.php';
...
require_once UELM_GlobalsUC::$pathProvider . 'provider_template_engine.class.php';
require_once $folderIncludesMain . 'unitecreator_settings.class.php';
require_once UELM_GlobalsUC::$pathProvider . 'provider_settings.class.php';
require_once UELM_GlobalsUC::$pathProvider . 'provider_settings_multisource.class.php';
...
require_once UELM_GlobalsUC::$pathProvider . 'provider_web_api.class.php';
...
require_once UELM_GlobalsUC::$pathProvider . 'provider_layouts.class.php';
...
require_once UELM_GlobalsUC::$pathProvider . 'provider_layout.class.php';

require_once UELM_GlobalsUC::$pathProvider . 'provider_library.class.php';
require_once UELM_GlobalsUC::$pathProvider . 'provider_library.class.php';
require_once $folderIncludesMain . 'unitecreator_dialog_param.class.php';
require_once UELM_GlobalsUC::$pathProvider."provider_dialog_param.class.php";
...
require_once UELM_GlobalsUC::$pathProvider . 'integrations.class.php';
...
require_once UELM_GlobalsUC::$pathProvider . 'provider_manager_addons.class.php';
...
require_once UELM_GlobalsUC::$pathProvider . 'provider_browser.class.php';
...
require_once UELM_GlobalsUC::$pathProvider . 'provider_layouts_exporter.class.php';
...
if(UELM_GlobalsUC::$is_admin){
 ...
 $filepathIncludeProviderAfter = UELM_GlobalsUC::$pathProvider."include_provider_after.php";
 if(file_exists($filepathIncludeProviderAfter))
 	require_once $filepathIncludeProviderAfter;

//require pro version files
if(file_exists(UELM_GlobalsUC::$pathPro."includes_pro.php"))
	require UELM_GlobalsUC::$pathPro."includes_pro.php";

UELM_GlobalsUC::initAfterIncludes();