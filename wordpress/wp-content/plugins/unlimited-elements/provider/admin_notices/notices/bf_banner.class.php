...
class UELM_UCAdminNoticeBFBanner extends UELM_UCAdminNoticeAbstract{
	...
	private function getInsideHTML(){ 
		...
		$urlLogoWhite = UELM_GlobalsUC::$urlPluginImages."logo-unlimited-white-image.png";
		
		$urlHeaderImage = UELM_GlobalsUC::$urlPluginImages."banners/bf-banner-header.png"; 
		
		$urlSmallImage = UELM_GlobalsUC::$urlPluginImages."banners/bf-notification.jpg"; 
		...
		$htmlCounter = '
			<img class="uc-bf-banner__counter" src="' . esc_url(UELM_GlobalsUC::$urlPluginImages . '2mgwko.gif') . '" style="display:inline-block!important;width:100%!important;max-width:272px!important;" border="0" alt="countdownmail.com"/>
		';
	...
	public function getHtml(){
		...
		$linkTarget = '_blank';
		//$imageUrl = UELM_GlobalsUC::$urlPluginImages . 'bannerimage.jpg';
		...
		$builder->dismissible();
		$builder->theme(UELM_UCAdminNoticeBannerBuilder::THEME_DARK);
	...
	protected function isConditionAllowed(){
		...
		if(UELM_GlobalsUC::$isInsidePlugin == true){
