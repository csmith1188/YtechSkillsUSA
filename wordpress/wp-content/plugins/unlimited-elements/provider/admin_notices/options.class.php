...
class UELM_UCAdminNoticesOptions{

	const OPTIONS_KEY = 'uelm_notices';
	...
	public static function getOption($key, $fallback = null){
		...
		$value = UELM_UniteFunctionsUC::getVal($options['options'], $key, $fallback);
	...
	public static function getNoticeOptions($id){
		...
		$options = self::getOptions();
		$noticeOptions = UELM_UniteFunctionsUC::getVal($options['notices'], $id, array());
	...
	public static function getNoticeOption($id, $key, $fallback = null){
		...
		$value = UELM_UniteFunctionsUC::getVal($noticeOptions, $key, $fallback);
