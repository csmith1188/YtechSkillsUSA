...
class UELM_UniteSettingsOutputUC extends UELM_UniteSettingsOutputUCWork{
	...
	protected function drawEditorInput($setting){
		...
		$settingsID = UELM_UniteFunctionsUC::getVal($setting, "id");
	...
	protected function drawPostPickerInput($setting){
		...
		$dataType = UELM_UniteFunctionsUC::getVal($setting, "post_select_type","post");
		...
		if(empty($placeholder) === true){
			...
			switch($dataType){
				...
				break;
				case "term":
					$placeholder = __("All Terms", "unlimited-elements");
				break;
				case "user":
					$placeholder = __("All Users", "unlimited-elements");
				break;
			}
