...
class UELM_UniteCreatorLayoutsViewProvider extends UELM_UniteCreatorLayoutsView{
	...
	public function display(){
		...
		if($this->objLayoutType->displayType != UELM_UniteCreatorAddonType_Layout::DISPLAYTYPE_MANAGER)
