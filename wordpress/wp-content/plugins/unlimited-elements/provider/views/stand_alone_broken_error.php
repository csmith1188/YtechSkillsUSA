...
class UELM_UnlimitedAddonsMigraterUC{
	...
	private function initVars(){
		...
		if(class_exists("UELM_GlobalsUC") && isset(UELM_GlobalsUC::$urlPlugin))
			$urlPlugin = UELM_GlobalsUC::$urlPlugin;
		else
	...
	private function isInsidePlugin(){
		$page = self::getGetVar("page","",UELM_UniteFunctionsUC::SANITIZE_KEY);
...
new UELM_UnlimitedAddonsMigraterUC();
