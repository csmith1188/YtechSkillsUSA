...
class UELM_UniteCreatorViewGeneralSettingsProvider extends UELM_UniteCreatorViewGeneralSettings{
	...
	protected function drawAdditionalTabs(){
		...
		?>
			<a data-contentid="uc_tab_developers" href="javascript:void(0)" onfocus="this.blur()"> <?php esc_html_e("Theme Developers", "unlimited-elements")?></a>
		<?php
	...
	*/
	protected function drawAdditionalTabsContent(){
		...
		$randomString = UELM_UniteFunctionsUC::getRandomString(5);
		...
		<div id="uc_tab_developers" class="uc-tab-content" style="display:none">
			...
			please create folder <b>"<?php UELM_GlobalsUC::DIR_THEME_ADDONS?>"</b> inside your theme and put the addons import zips there. <br>
			example: <b>wp-content/themes/yourtheme/<?php echo esc_attr(UELM_GlobalsUC::DIR_THEME_ADDONS)?></b>
