...
class UELM_UniteCreatorAddonType_Elementor_Template extends UELM_UniteCreatorAddonType_Layout{
	...
	protected function initChild(){
		...
		$this->typeName = UELM_GlobalsUnlimitedElements::ADDONSTYPE_ELEMENTOR_TEMPLATE;
		...
		$this->postType = UELM_GlobalsUnlimitedElements::POSTTYPE_UNLIMITED_ELEMENS_LIBRARY;
		...
		$urlLicense = UELM_HelperUC::getViewUrl(UELM_GlobalsUnlimitedElements::VIEW_LICENSE_ELEMENTOR);		
		...
		$this->addonView_urlBack = UELM_HelperUC::getViewUrl(UELM_GlobalsUnlimitedElements::VIEW_TEMPLATES_ELEMENTOR);
		...
		UELM_UniteProviderFunctionsUC::doAction("uc_init_elementor_template_addontype", $this);
