...
(function (wp) {
    ...
    var edit = function (props) {
        ...
        const ucSettingsRef     = we.useRef(new UELM_UniteSettingsUC());
        const ucHelperRef       = we.useRef(new UELM_UniteCreatorHelper());
        ...
        */
        ...
        var loadWidgetContent = function (overrideSettings) {
            ...
            if (!widgetContent) {
                ...
                for (var i = 0; i < uelm_g_gutenbergParsedBlocks.length; i++) {
                    var block = uelm_g_gutenbergParsedBlocks[i];
                    ...
                    if (block && block.name === props.name && block.html) {
                        ...
                        delete uelm_g_gutenbergParsedBlocks[i];
    ...
    for (var name in uelm_g_gutenbergBlocks) {
        var block = uelm_g_gutenbergBlocks[name];
