...
class UELM_UniteCreatorDialogParamElementor extends UELM_UniteCreatorDialogParam{
	...
	private function addHtmlSelector(){
		...
		<div class="unite-inputs-label">
			<?php esc_html_e("CSS Selector", "unlimited-elements")?>:
		</div>

		<input type="text" name="selector"  value="" placeholder="<?php esc_attr_e("Example","unlimited-elements")?> .my-price">

		<div class="unite-inputs-sap"></div>

		<i><?php esc_attr_e("* This attribute generate css only within the css selectors, it don't have placeholder in the widget editor","unlimited-elements")?></i>
	...
	private function addHtmlSelectorNameValue($selectorPlaceholder = "", $selectorValuePlaceholder = "", $value = "", $bottomTextUnits = ""){
		...
		if(empty($selectorPlaceholder))
			$selectorPlaceholder = __("Example .my-price", "unlimited-elements");
		...
		$bottomText = __("* You can use those placeholders: ", "unlimited-elements") . $bottomTextUnits;

		$checkID = "check_".UELM_UniteFunctionsUC::getRandomString();
		...
		<div class="unite-inputs-label">
			<?php esc_html_e("CSS Selector Value", "unlimited-elements")?>:
		</div>
		...
		<label for="<?php echo esc_attr($checkID)?>">
			...
			<?php esc_attr_e("Show More Selectors", "unlimited-elements")?>
		</label>
		...
		<div class="uc-more-selectors" style="display:none">
				...
				<div class="unite-inputs-label">
					<?php esc_html_e("CSS Selector 2", "unlimited-elements")?>:
				</div>
				...
				<div class="unite-inputs-label">
					<?php esc_html_e("CSS Selector 2 Value", "unlimited-elements")?>:
				</div>
				...
				<div class="unite-inputs-label">
					<?php esc_html_e("CSS Selector 3", "unlimited-elements")?>:
				</div>
				...
				<div class="unite-inputs-label">
					<?php esc_html_e("CSS Selector 3 Value", "unlimited-elements")?>:
				</div>
	...
	private function addResponsiveInputs($type){
		...
		<label for="<?php echo esc_attr($checkID)?>">
			...
			<?php esc_attr_e("Responsive Control", "unlimited-elements")?>
		</label>
		...
		<div class="uc-responsive-controls" style="display:none">
			...
			<div class="params-dialog-table">
				...
				<div class="params-table-item">
					<div class="unite-inputs-label">
						<?php esc_html_e("Default Value - Tablet", "unlimited-elements")?>
					</div>
				...
				<div class="params-table-item">
					<div class="unite-inputs-label">
						<?php esc_html_e("Default Value - Mobile", "unlimited-elements")?>
					</div>
	...
	protected function putMenuParam(){
		...
		$settings->addTextBox("menu_class","uc-list-menu","Menu Class",array("description"=>"The class on menu ul element","unlimited-elements"));
		$settings->addTextBox("before","","Html Before Link",array("description"=>"The html that are put before link if needed","unlimited-elements"));
		$settings->addTextBox("after","","Html After Link",array("description"=>"The html that are put after the link if needed","unlimited-elements"));
		...
		<i>
			* <?php esc_attr_e("Information about menu classes you can find here", "unlimited-elements")?>:

			<a href="https://developer.wordpress.org/reference/functions/wp_nav_menu/" target="_blank"><?php esc_attr_e("WP Menu Reference","unlimited-elements")?></a>
	...
	protected function putUsersParam(){
		...
		esc_html_e("Use this attribute to get the WP Users List", "unlimited-elements");
		...
		<label for="<?php echo esc_attr($checkID)?>" >
			...
			<?php esc_attr_e("Include User Meta Data", "unlimited-elements")?>
		</label>
		...
		<label for="<?php echo esc_attr($checkIDAvatar)?>" >
			...
			<?php esc_attr_e("Include Avatar", "unlimited-elements")?>
		</label>
	...
	protected function putIconLibraryParam(){
		...
		<label for="<?php echo esc_attr($checkID)?>" >
			...
			<?php esc_attr_e("Enable SVG Select", "unlimited-elements")?>
		</label>
		...
		<label class="uc-put-svg-fields">
			...
			<?php esc_attr_e("Put SVG as", "unlimited-elements")?>

			<select name="put_svg_as">
				<option value="image" selected><?php esc_attr_e("Image","unlimited-elements")?></option>
				<option value="svg"><?php esc_attr_e("SVG Output","unlimited-elements")?></option>
			</select>
	...
	protected function putBorderParam(){
		...
		$objSettings->addSelect("border_type", $arrType, __("Border Type", "unlimited-elements"), "none");

		$params = array();
		$params[UELM_UniteSettingsUC::PARAM_CLASSADD] = "uc-text-colorpicker";
		...
		?>
		<div class="unite-inputs-label">
			<?php esc_html_e("Border Type", "unlimited-elements")?>:
		</div>
		...
		<div class="unite-inputs-label">
			<?php esc_html_e("Border Color", "unlimited-elements")?>:
		</div>
		...
		<div class="unite-inputs-label">
			<?php esc_html_e("Border Width", "unlimited-elements")?>:
		</div>
		...
		<div class="unite-inputs-label">
			<?php esc_html_e("Border Width - Tablet", "unlimited-elements")?>:
		</div>
		...
		<div class="unite-inputs-label">
			<?php esc_html_e("Border Width - Mobile", "unlimited-elements")?>:
		</div>
	...
	protected function putSliderParam(){
		...
		$arrUnits["%"] = "%";
		$arrUnits["em"] = "EM";
		$arrUnits["vh"] = __("VH","unlimited-elements");
		$arrUnits["vw"] = __("VW","unlimited-elements");
		$arrUnits["percent_px"] = __("%, PX","unlimited-elements");
		$arrUnits["px_percent"] = __("PX, %","unlimited-elements");
		$arrUnits["px_percent_em"] = __("PX, %, EM","unlimited-elements");
		$arrUnits["vh_px"] = __("VH, PX, REM","unlimited-elements");
		$arrUnits["px_vh"] = __("PX, VH, REM","unlimited-elements");
		$arrUnits["px_vh_percent"] = __("PX, VH, %","unlimited-elements");
		$arrUnits["vw_px"] = __("VW, PX","unlimited-elements");
		$arrUnits["px_vw"] = __("PX, VW","unlimited-elements");
		$arrUnits["px_vw_percent"] = __("PX, VW, %","unlimited-elements");
		...
		$objSettings->addTextBox("default_value","20",__("Default Value","unlimited-elements"),$params);
		$objSettings->addTextBox("min","1",__("Min","unlimited-elements"),$params);
		$objSettings->addTextBox("max","100",__("Max","unlimited-elements"),$params);
		$objSettings->addTextBox("step","1",__("Step","unlimited-elements"),$params);

		$objSettings->addSelect("units", $arrUnits, __("Units", "unlimited-elements"),"px");
		...
		<div class="params-dialog-table">
			...
			<div class="params-table-item">
				<div class="unite-inputs-label">
					<?php esc_html_e("Min", "unlimited-elements")?>:
				</div>
			...
			<div class="params-table-item">
				...
				<div class="unite-inputs-label">
					<?php esc_html_e("Max", "unlimited-elements")?>:
				</div>
			...
			<div class="params-table-item">
				...
				<div class="unite-inputs-label">
					<?php esc_html_e("Step", "unlimited-elements")?>:
				</div>
			...
			<div class="params-table-item">
				...
				<div class="unite-inputs-label">
					<?php esc_html_e("Units", "unlimited-elements")?>:
				</div>
		...
		<div class="unite-dialog-description-left">
			<?php esc_attr_e("* In case of multiple units, the min, max apply to px unit only.", "unlimited-elements")?>
		</div>
		...
		?>
			...
			<div class="vert_sap10"></div>
             ...
             <div class="pro-settings-checkbox">
                 <?php $this->putCheckbox("is_pro", __("Pro Setting", "unlimited-elements")); ?>
             </div>
			...
			<table data-inputtype="radio_boolean"  class='uc-table-dropdown-items uc-table-dropdown-full'>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<div class='uc-dropdown-icon uc-dropdown-item-default' title="<?php esc_html_e("Default Item", "unlimited-elements")?>"></div>
						</td>
					</tr>
	...
	protected function putBackgroundParam(){
		...
		$objSettings->addSelect("solid_bg_image_position", $arrPosition, __("Background Image Position", "unlimited-elements"));
		...
		$objSettings->addSelect("solid_bg_image_repeat", $arrRepeat, __("Background Image Repeat", "unlimited-elements"));
		...
		$objSettings->addSelect("solid_bg_image_size", $arrSize, __("Background Image Size", "unlimited-elements"));
		...
		?>
			<div class='uc-paramsdialog-radio-chooser uc-radioset-wrapper' data-defaultchecked="none">
				...
				<label>
					<?php esc_attr_e("None","unlimited-elements")?>:
				...
				<label>
					<?php esc_attr_e("Solid","unlimited-elements")?>:
				...
				<label>
					<?php esc_attr_e("Gradient","unlimited-elements")?>
			...
			<div class="uc-controls-solid" style="display:none">
				...
				<label><?php esc_attr_e("Solid Color","unlimited-elements")?></label>
				...
				<?php $this->putImageSelectInput("solid_bg_image", esc_html__("Background Image","unlimited-elements"))?>

				<div class="vert_sap10"></div>

				<label><?php esc_attr_e("Image Position","unlimited-elements")?></label>
				...
				<div class="vert_sap10"></div>
				<label><?php esc_attr_e("Image Repeat","unlimited-elements")?></label>
				...
				<div class="vert_sap10"></div>
				<label><?php esc_attr_e("Image Size","unlimited-elements")?></label>
			...
			<div class="uc-dialogparam-horlist uc-controls-gradient" style="display:none">
				...
				<label>
					<?php esc_attr_e("Gradient Color1", "unlimited-elements")?>

					<?php $objOutput->drawSingleSetting("gradient_color1"); ?>

				</label>
				<label>
					<?php esc_attr_e("Gradient Color2", "unlimited-elements")?>
	...
	protected function putDateTimeParam(){
		...
		$htmlSelect = UELM_HelperHtmlUC::getHTMLSelect($arrModes, "", "name='date_time_mode'", true, "date");


		?>

		<div class="unite-inputs-label">
			<?php esc_attr_e("Date Time", "unlimited-elements")?>:
		</div>
		...
		<i><?php esc_attr_e("* The default value can be empty as well","unlimited-elements")?></i>

		<div class="unite-inputs-sap-double"></div>

		<div class="unite-inputs-label">
			<?php esc_attr_e("Date / Time Mode", "unlimited-elements")?>:
	...
	protected function putTextShadowParam(){
		...
		$objSettings->addTextBox("blur", "20", __("Default Value","unlimited-elements"),$params);
		$objSettings->addTextBox("horizontal", "1", __("Min","unlimited-elements"),$params);
		$objSettings->addTextBox("vertical", "100", __("Max","unlimited-elements"),$params);

		$textColor = __("Default Color","unlimited-elements");
		...
		?>
			...
			<label for="<?php echo esc_attr($checkID)?>">
				...
				<?php esc_attr_e("Enable Default Values", "unlimited-elements")?>
			</label>
			...
			<div class="uc-default-settings">
					...
					<div class="unite-inputs-label">
						<?php esc_html_e("Color", "unlimited-elements")?>:
					</div>
					...
					<div class="unite-inputs-label">
						<?php esc_html_e("Blur", "unlimited-elements")?>:
					</div>
					...
					<div class="unite-inputs-label">
						<?php esc_html_e("Horizontal", "unlimited-elements")?>:
					</div>
					...
					<div class="unite-inputs-label">
						<?php esc_html_e("Vertical", "unlimited-elements")?>:
					</div>
	...
	protected function putHoverAnimations(){
		...
		esc_html_e("Default Value", "unlimited-elements");

		$arrAnimations = UELM_HelperProviderCoreUC_EL::getHoverAnimationClasses();

		$htmlSelect = UELM_HelperHtmlUC::getHTMLSelect($arrAnimations, "", "name='default_value'", true, "not_chosen");
		...
		?>
			...
			<div class="vert_sap10"></div>
 		    ...
 		    <p>
 		    <?php esc_attr_e("Add the value of this attribute to the class list of your html element","unlimited-elements")?>
 		    </p>
		<?php
	...
	protected function putSpecialAttribute(){
		...
		$arrTypes = array();
		$arrTypes["none"] = __("[Select Type]","unlimited-elements");
		$arrTypes["entrance_animation"] = __("Entrance Animation","unlimited-elements");
		$arrTypes["items_image_size"] = __("Items Image Size","unlimited-elements");
		$arrTypes["schema"] = __("Schema","unlimited-elements");
		$arrTypes["dynamic_popup"] = __("Dynamic Popup","unlimited-elements");
		$arrTypes["contact_form7"] = __("Contact Form 7","unlimited-elements");
		$arrTypes["ucform_conditions"] = __("Unite Form Conditions","unlimited-elements");
		$arrTypes["sort_filter_fields"] = __("Sort Filter Fields","unlimited-elements");
		$arrTypes["currency_api"] = __("Currency API Fields","unlimited-elements");
		$arrTypes["weather_api"] = __("Weather API Fields","unlimited-elements");
		$arrTypes["rss_feed"] = __("Rss Feed Fields","unlimited-elements");
		$arrTypes["repeater"] = __("Repeater","unlimited-elements");
		$arrTypes["reviews"] = __("Google Reviews","unlimited-elements");
		
		$optionsClass = "uc-special-attribute-options";
		
		$htmlSelectTypes = UELM_HelperHtmlUC::getHTMLSelect($arrTypes, "", "name='attribute_type' class='uc-control' data-controlled-selector='.{$optionsClass}'", true, "refresh");

		?>

			<?php esc_html_e("Special Attribute Type", "unlimited-elements"); ?>
			...
			<div class="vert_sap30"></div>
 		    ...
 		    <div class="<?php echo esc_attr($optionsClass)?>" data-control="entrance_animation" style="display:none">
				...
				<div class="unite-inputs-label">
			 		    <?php esc_attr_e("Item Class","unlimited-elements")?>
				</div>
...
<!-- image size -->
 		    ...
 		    <div class="<?php echo esc_attr($optionsClass)?>" data-control="items_image_size" style="display:none">
				...
				<div class="unite-inputs-label">
			 		    <?php esc_attr_e("Items Attribute Name","unlimited-elements")?>
				</div>

 		    	<input type="text" name="image_size_param_name" value="" placeholder="Example: image1">

				<div class="unite-dialog-description-left">
					<?php esc_attr_e("* If leave empty, then the image size chooser will affect the first item image attribute.", "unlimited-elements")?>
				</div>
 		    ...
 		    <div class="<?php echo esc_attr($optionsClass)?>" data-control="dynamic_popup" style="display:none">
				...
				<div class="unite-inputs-label">
			 		    <?php esc_attr_e("Attribute Suffix","unlimited-elements")?>
				</div>

 		    	<input type="text" name="dynamic_popup_suffix" value="" placeholder="Example: title">

				<div class="unite-dialog-description-left">
					<?php esc_attr_e("For the button leave it empty.", "unlimited-elements")?>
				</div>
	...
	protected function putColorPickerDefault(){
		...
		?>
			...
			$placeholder = __("Example: .my-box", "unlimited-elements");
	...
	protected function putNumberUnitSelect(){
		?>
				<div class="unite-inputs-label-inline-suffix">
					<?php esc_html_e("Suffix", "unlimited-elements")?>:
				</div>
	...
	private function putNumberMaxMinInputs(){
		...
		<span class="unite-inputs-label"><?php esc_attr_e("Min Value", "unlimited-elements")?></span>:
		<input type="text" name="min_value" class="input-small">

		&nbsp;&nbsp;

		<span class="unite-inputs-label"><?php esc_attr_e("Max Value", "unlimited-elements")?></span>:
		<input type="text" name="max_value" class="input-small">

		&nbsp;&nbsp;

		<span class="unite-inputs-label"><?php esc_attr_e("Step", "unlimited-elements")?></span>:
		<input type="text" name="step" class="input-small" placeholder="1">

		<div class="unite-dialog-description-left">
			<?php esc_attr_e("* Those settings are for the attribute up and down arrows only.", "unlimited-elements")?>
		</div>
	...
	protected function putNumberParam(){
		...
		$bottomText = __("* You can use those placeholders: {{VALUE}} &nbsp; {{CURRENT_ITEM}}", "unlimited-elements");
	...
	protected function putDimentionsParam($type = ""){
		...
		$title = __("Margins","unlimited-elements");
		if($type == "padding")
			$title = "Padding";
		...
		<div class="unite-inputs-label">
			<?php uelm_echo(esc_attr($title) . __(" Default Values", "unlimited-elements") )?>:
		</div>

		<div class="unite-inputs-sap"></div>

		<div class="unite-inputs-label uc-label-desktop" style="display:none">
			<?php esc_html_e("Desktop", "unlimited-elements")?>:
		</div>
		...
		<div class="uc-responsive-controls" style="display:none">
				...
				<div class="unite-inputs-label">
					<?php esc_html_e("Tablet", "unlimited-elements")?>:
				</div>
				...
				<div class="unite-inputs-label">
					<?php esc_html_e("Mobile", "unlimited-elements")?>:
				</div>
		...
		<div class="unite-inputs-label">
			...
			<?php esc_html_e("Additional Units", "unlimited-elements")?>:
		</div>

		<input type="text" name="add_units" value="">

		<div class="unite-dialog-description-left">
			* <?php esc_html_e("Here you can specify additional units comma separated like vw, vh etc.", "unlimited-elements")?>
		</div>
	...
	protected function putTypographyParamField(){
		...
		<div class="unite-inputs-label">
			...
			<?php esc_html_e("CSS Selector 2 (optional)", "unlimited-elements")?>:
		</div>
		...
		<div class="unite-inputs-label">
			...
			<?php esc_html_e("CSS Selector 3 (optional)", "unlimited-elements")?>:
		</div>

		<input type="text" name="selector3" value="">

		<div class="unite-dialog-description-right">
			* <?php esc_html_e("The selector that the typography field will be related to. Can be related to several html tags.", "unlimited-elements")?>
		</div>
	...
	protected function initByAddonType($addonType){
		...
		if($addonType != UELM_GlobalsUnlimitedElements::ADDONSTYPE_ELEMENTOR)
			return(false);
